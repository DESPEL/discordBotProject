...
glob.sync('./lib/experimentalcmds/**/*.js').forEach(function (file) {
...
module.exports.search = module.exports.google;


//Función para convertir comandos de objetos a funciones
