...
module.exports = async function (message, nsfw = "") {
...
module.exports.description = "Permite obtener una imagen aleatoria, <nsfw> puede ser nada, 'all', '+18'";
module.exports.args = "<nsfw>"
